...
<head>
  ...
  <script type="text/javascript">
    ...
    ADI.videoLoaderSrc = 'https://static.parastorage.com/services/adi-web/2.4659.0/assets/videos/loader.mp4';
...
<script src="https://static.parastorage.com/services/media-manager-api/1.898.0/media-manager-api.js" crossorigin="anonymous"></script>
...
<script type="text/javascript">
  (function (window) {
    ...
    url += '&editorSessionId=bba00e3c-2f7f-4043-8229-7e22fcc9bcbb';
    ADI.storyCache = {};
...
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4659.0/third-parties-clean-js.bundle.min.js"></script>
<!--  -->
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4659.0/second-parties-js.bundle.min.js"></script>
...
<script>
  ADI.clientTopology = {
    ...
    staticsVersion: '2.4659.0',
    staticsUrl: 'https://static.parastorage.com/services/adi-web/2.4659.0/',
    ...
    mediaGalleryUrl: 'https://www.wix.com/_partials/media-gallery-g5/1.1206.0/',
    mediaManagerPartialsUrlG6: 'https://www.wix.com/_partials/media-manager-g6/1.1770.0/',
    santaEditorStaticsUrl: '//static.parastorage.com/services/santa-editor/1.12761.0/',
  };
</script>
...
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4659.0/first-parties-js.bundle.min.js"></script>
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4659.0/assets/locale/messages_en.js"></script>
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4659.0/assets/common-controls/locale/messages_en.js"></script>
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4659.0/assets/organize-media/locale/messages_en.js"></script>
...
<script>
  ...
  <ng-include
      src="'https://static.parastorage.com/services/adi-web/2.4659.0/assets/common-controls/svg-sprites-complex/icons.sprite.svg'"></ng-include>
    <ng-include
      src="'https://static.parastorage.com/services/adi-web/2.4659.0/assets/common-controls/svg-sprites/icons.sprite.svg'"></ng-include>
  </div>
  ...
  <script>ADI.lazyLoadCss('https://static.parastorage.com/services/adi-web/2.4659.0/third-parties-css.min.css');</script>
  <script>ADI.lazyLoadCss('https://static.parastorage.com/services/adi-web/2.4659.0/first-parties-js.min.css');</script>
</body>
</html>
